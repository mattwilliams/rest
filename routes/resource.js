...
exports.list = function(mongoose) {
  var mongo = mongoose;
	console.log("LIST GET RESOURCE");
	
//	http://api.remix.bestbuy.com/v1/products(search=camera&salePrice%3C500)?apiKey=ptafrhg64xq5gjete2pz9xfm&sort=regularPrice.asc&show=url
...
exports.setup = function(app, options) {
	console.log("OPTIONS FROM RESOURCE");
	console.log(options);
  options = options || {};
